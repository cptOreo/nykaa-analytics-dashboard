...
def build_page8(year):
    ...
    propositions = html.Div(style={'marginTop': '32px'}, children=[
        ...
        proposition_card(3,
            "Return-heavy customers show different loyalty behaviour.",
            "Survey data shows returners have different repurchase intent and share-of-wallet patterns vs non-returners.",
        ),
        proposition_card(4,
